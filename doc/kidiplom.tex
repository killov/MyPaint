...
Horní panel aplikace slouží pro výběr nástroje pro práci. Funguje jako přepínač a současně lze zvolit pouze jeden nástroj. Následně uvedu jednotlivé nástroje.
...
\subsection{Vrstvy}
Na levé straně u spodní části grafického editoru nalezneme panel vrstev. Obsahuje seznam vrstev, které si uživatel pomocí tlačítka \uv{přidat} může přidat \uv{libovolné} množství.   
